...
<head>
    ...
    <title>La Cerisaie - Types emplacement</title>
</head>
<body>
<header>
                        ...
                        <div style="height:700px">
                            ...
                            <TABLE BORDER="0" class="table table-hover text-center card" style="background-color:rgba(0, 0, 0, 0.3); max-height: 100% ; overflow-y: auto; overflow-x: hidden">
                                ...
                                <TR class="row justify-content-center">
                                    ...
                                    <TH class="col" scope="col">Tarif</TH>
                                </TR>
                                </thead>
                                <tbody class="white-text">
                                <c:forEach items="${mesTypesEmplacement}" var="tye">
                                    <tr class="row justify-content-center">
                                        <td class="col" scope="row">${tye.codeTypeE}</td>
                                        <td class="col">${tye.libtypepl}</td>
                                        <td class="col">${tye.tariftypepl}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </TABLE>
